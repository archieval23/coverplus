...
Public Class crSwabResult
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CovidTestResult.crSwabResult.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrSwabResult
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crSwabResult = New crSwabResult()
        rpt.Site = Me.Site
        Return rpt
    End Function
